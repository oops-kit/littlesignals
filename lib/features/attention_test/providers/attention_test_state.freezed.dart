...
/// 이미 확인한 카드 ID 집합
 ...
 DateTime? get lastFlipTime;/// 힌트 사용 횟수 (기획서: 힌트 사용 시 0.5점 차감)
...
@useResult
$Res call({
 AttentionGameState gameState, int? countdownValue, int level, List<CardData> cards, List<int> flippedCardIds, bool isProcessing, DateTime? startTime, int moves, int errors, int? hintCardId, bool isCompleted, int randomTaps, int immediateRepeatErrors, List<TapRecord> tapRecords, List<int> recentlyFlippedCardIds, DateTime? firstHalfEndTime, int firstHalfTaps, int secondHalfTaps, List<TestEventLog> eventLogs, Set<int> revealedCardIds, int revisitCount, int totalTurns, List<int> reactionTimesMs, DateTime? lastFlipTime, int hintUsedCount
});
...
/// Create a copy of AttentionTestState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? gameState = null,Object? countdownValue = freezed,Object? level = null,Object? cards = null,Object? flippedCardIds = null,Object? isProcessing = null,Object? startTime = freezed,Object? moves = null,Object? errors = null,Object? hintCardId = freezed,Object? isCompleted = null,Object? randomTaps = null,Object? immediateRepeatErrors = null,Object? tapRecords = null,Object? recentlyFlippedCardIds = null,Object? firstHalfEndTime = freezed,Object? firstHalfTaps = null,Object? secondHalfTaps = null,Object? eventLogs = null,Object? revealedCardIds = null,Object? revisitCount = null,Object? totalTurns = null,Object? reactionTimesMs = null,Object? lastFlipTime = freezed,Object? hintUsedCount = null,}) {
  return _then(_self.copyWith(
...
as DateTime?,hintUsedCount: null == hintUsedCount ? _self.hintUsedCount : hintUsedCount // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( AttentionGameState gameState,  int? countdownValue,  int level,  List<CardData> cards,  List<int> flippedCardIds,  bool isProcessing,  DateTime? startTime,  int moves,  int errors,  int? hintCardId,  bool isCompleted,  int randomTaps,  int immediateRepeatErrors,  List<TapRecord> tapRecords,  List<int> recentlyFlippedCardIds,  DateTime? firstHalfEndTime,  int firstHalfTaps,  int secondHalfTaps,  List<TestEventLog> eventLogs,  Set<int> revealedCardIds,  int revisitCount,  int totalTurns,  List<int> reactionTimesMs,  DateTime? lastFlipTime,  int hintUsedCount)  $default,) {final _that = this;
switch (_that) {
case _AttentionTestState():
return $default(_that.gameState,_that.countdownValue,_that.level,_that.cards,_that.flippedCardIds,_that.isProcessing,_that.startTime,_that.moves,_that.errors,_that.hintCardId,_that.isCompleted,_that.randomTaps,_that.immediateRepeatErrors,_that.tapRecords,_that.recentlyFlippedCardIds,_that.firstHalfEndTime,_that.firstHalfTaps,_that.secondHalfTaps,_that.eventLogs,_that.revealedCardIds,_that.revisitCount,_that.totalTurns,_that.reactionTimesMs,_that.lastFlipTime,_that.hintUsedCount);case _:
  throw StateError('Unexpected subclass');
...
@override
int get hashCode => Object.hashAll([runtimeType,gameState,countdownValue,level,const DeepCollectionEquality().hash(_cards),const DeepCollectionEquality().hash(_flippedCardIds),isProcessing,startTime,moves,errors,hintCardId,isCompleted,randomTaps,immediateRepeatErrors,const DeepCollectionEquality().hash(_tapRecords),const DeepCollectionEquality().hash(_recentlyFlippedCardIds),firstHalfEndTime,firstHalfTaps,secondHalfTaps,const DeepCollectionEquality().hash(_eventLogs),const DeepCollectionEquality().hash(_revealedCardIds),revisitCount,totalTurns,const DeepCollectionEquality().hash(_reactionTimesMs),lastFlipTime,hintUsedCount]);
